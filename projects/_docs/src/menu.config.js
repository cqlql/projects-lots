...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      //   name: '切换效果-多元素',
      //   path: '/switch-multi',
      //   demo: () => import(/* webpackChunkName: "docs1" */ '@/libs/switch-multi/demo.vue'),
      //   noDocs: true,
      //   env: 'pc'
      //   // docs: () => import(/* webpackChunkName: "docs1" */ '@/libs/switch-multi/README.md')
      // },
      // {
      //   name: '切换效果-单元素',
      //   path: '/switch-one',
      //   demo: () => import(/* webpackChunkName: "docs1" */ '@/libs/switch-one/demo.vue'),
      //   noDocs: true,
      //   env: 'pc'
      //   // docs: () => import(/* webpackChunkName: "docs1" */ '@/libs/switch-multi/README.md')
      // },
    ...
    children: [
      {
        name: '双指捏合放大',
        path: '/zoom-touch',
        demo: () => import(/* webpackChunkName: "docs1" */ '@/libs/zoom-touch/demo.vue'),
        docs: () => import(/* webpackChunkName: "docs1" */ '@/libs/zoom-touch/README.md')
      },
      {
        name: 'toast 轻提醒-js版',
        path: '/toast-js',
        demo: () => import(/* webpackChunkName: "docs1" */ '@/libs/toast/Demo.vue'),
        docs: () => import(/* webpackChunkName: "docs1" */ '@/libs/toast/README.md')
      },
      {
        name: 'loading-js版',
        path: '/loading-js',
        demo: () => import(/* webpackChunkName: "docs1" */ '@/libs/loading/Demo.vue'),
        docs: () => import(/* webpackChunkName: "docs1" */ '@/libs/loading/README.md')
      },
    ]
  },
  {
